...
return [
    'BreadcrumbModuleRoutingMap' => 'Карта маршрутизации звонков',
    'SubHeaderModuleRoutingMap' => 'Интерактивная визуализация входящей и исходящей маршрутизации',
    'module_routing_map' => 'Карта маршрутизации звонков',
    ...
    'module_routing_map_PageTitle' => 'Карта маршрутизации звонков',
    ...
    'rest_tag_ModuleRoutingMapGraph' => 'Карта маршрутизации звонков - Graph',
